...
日付を持たない場別テーブル。上流の monthly-weights が月 1 回だけ更新し、
preview-realtime / daily-sync の GCS ミラーに相乗りして配信される。
