...
- 2026-05: preview-realtime が 5 分間隔で CSV を更新するようになったのに合わせ、朝バッチを廃止し Pub/Sub → Eventarc → Workflow → Cloud Run Job のイベント駆動チェーンに移行。リージョンも `us-central1` から `asia-northeast1` に統一
