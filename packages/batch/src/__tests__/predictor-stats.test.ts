...
import { aggregatePredictorStats as aggregateDigests } from "../aggregator/predictor-stats.js";

/** テストは RacePrediction で組み立て、集計器には本番と同じダイジェストを渡す。 */
const aggregatePredictorStats = (predictions: readonly RacePrediction[]) =>
